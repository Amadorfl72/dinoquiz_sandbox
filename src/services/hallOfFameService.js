 ...
 *
 * The implementation lives in public/scripts/hallOfFameService.js because the
 * Hall of Fame screen (public/scripts/hallOfFameScreen.js) has to read/write
 * it live in the browser without a bundler -- it is loaded there as a
