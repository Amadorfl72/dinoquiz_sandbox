 ...
 *
 * The implementation lives in public/scripts/audio.js because, without a
 ...
 * of truth (mirrors src/game/scoring.js re-exporting public/scripts/scoring.js).
 */

module.exports = require('../../public/scripts/audio');
