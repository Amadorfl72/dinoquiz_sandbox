...
describe('ResultsScreen', () => {
  ...
  describe('motivating messages based on score ranges', () => {
    ...
    it.each(rangeCases)(
      ...
      (score) => {
        render(<ResultsScreen score={score} onReplay={jest.fn()} />);
    ...
    it('renders the same message for all scores in the 0-3 range', () => {
      const { unmount: u0 } = render(<ResultsScreen score={0} onReplay={jest.fn()} />);
      const m0 = screen.getByTestId('motivating-message').textContent;
      u0();
      const { unmount: u3 } = render(<ResultsScreen score={3} onReplay={jest.fn()} />);
    ...
    it('renders the same message for all scores in the 4-6 range', () => {
      const { unmount: u4 } = render(<ResultsScreen score={4} onReplay={jest.fn()} />);
      const m4 = screen.getByTestId('motivating-message').textContent;
      u4();
      const { unmount: u6 } = render(<ResultsScreen score={6} onReplay={jest.fn()} />);
    ...
    it('renders the same message for all scores in the 7-8 range', () => {
      const { unmount: u7 } = render(<ResultsScreen score={7} onReplay={jest.fn()} />);
      const m7 = screen.getByTestId('motivating-message').textContent;
      u7();
      const { unmount: u8 } = render(<ResultsScreen score={8} onReplay={jest.fn()} />);
    ...
    it('renders the same message for all scores in the 9-10 range', () => {
      const { unmount: u9 } = render(<ResultsScreen score={9} onReplay={jest.fn()} />);
      const m9 = screen.getByTestId('motivating-message').textContent;
      u9();
      const { unmount: u10 } = render(<ResultsScreen score={10} onReplay={jest.fn()} />);
  ...
  describe('"Volver a jugar" button', () => {
    ...
    it('calls onReplay when clicked', () => {
      ...
      render(<ResultsScreen score={5} onReplay={onReplay} />);
      const button = screen.getByRole('button', { name: /Volver a jugar/i });
  ...
  describe('edge cases', () => {
    it('clamps negative scores to the 0-3 range message', () => {
      render(<ResultsScreen score={-1} onReplay={jest.fn()} />);
      const message = screen.getByTestId('motivating-message');
      expect(message).toBeInTheDocument();
    });

    it('clamps scores above 10 to the 9-10 range message', () => {
      render(<ResultsScreen score={11} onReplay={jest.fn()} />);
      const message = screen.getByTestId('motivating-message');
      expect(message).toBeInTheDocument();
    });
  });
