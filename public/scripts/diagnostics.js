 ...
 *
 * Browser bridge (TRIOFSND-319): the diagnostics screen
 * (public/scripts/diagnosticsScreen.js) is the first caller that needs this
...
(function () {
  ...
  function recordError(mode, category, code, storageAdapter) {
    ...
    var trimmed = errors.length > MAX_ERROR_ENTRIES ? errors.slice(errors.length - MAX_ERROR_ENTRIES) : errors;
