...
(function () {
  ...
  function renderMuteToggleButton(container, options) {
    ...
    // public/styles/main.css: inline styles guarantee the AC-2/AC-11 48x48dp
    // touch target even before that stylesheet loads or in contexts that
    // skip it entirely (e.g. jsdom/unit tests that mount into a bare,
    // unstyled document).
